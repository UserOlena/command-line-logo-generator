class Shapes {
    ...
    renderLogoText(text, fontColor) {
        return `<text x="150" y="115" font-size="40" text-anchor="middle" fill="${fontColor}">${text}</text>`
    }  
}
...
class Triangle extends Shapes {
    ...
    renderLogoText(text, fontColor) {
        return `<text x="150" y="125" font-size="40" text-anchor="middle" fill="${fontColor}">${text}</text>`
    }  
}
